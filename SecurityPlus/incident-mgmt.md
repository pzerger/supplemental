...
The incident management framework used in the Security+ SY0-601 exam is the SANS incident response framework. We can also learn more about the incident management and response process by drawing parallels to NIST and the CISSP, two widely referenced frameworks for incident management and response.
